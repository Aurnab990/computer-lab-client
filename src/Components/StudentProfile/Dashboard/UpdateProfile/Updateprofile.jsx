...
const Updateprofile = () => {
    ...
    const handleAddstudents = (event) => {
      ...
      const user = { name, semester,email,advisorname,courses };
      //console.log(user);
...
<div className='mt-10 items-center justify-center b '>
    <form onSubmit={handleAddstudents}>
    Name: <input className='w-1/3 p-2 rounded-xl ml-14 bg-white border-2 text-black' name='sname' required></input>
    <br></br>
    <br></br>
    Your Semester: <input className='w-1/3 p-2 rounded-xl bg-white border-2 text-black' name='semester' required></input>
    <br></br>
    Advisor Name: <input className='mt-5 w-1/3 p-2 rounded-xl bg-white border-2 text-black' name='advisorname' required></input>
    <br></br>
    Your Email: <input className='mt-5 w-1/3 p-2 rounded-xl ml-8 bg-white border-2 text-black' name='email' value={user?.email} required ></input>
    <br></br>
    
    Courses Name: <input className='mt-5 w-1/3 p-2 rounded-xl bg-white border-2 text-black' name='courses' required></input>
    <br></br>
    <br></br>
