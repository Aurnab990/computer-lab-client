...
const Dignitaries = () => {
  return (
    <div className="lg:flex gap-4 m-5 p-5 bg-white">
      <Tilt tiltMaxAngleX={30} tiltMaxAngleY={30}>
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
            <img
              className="rounded-t-lg"
              src="https://www.easternuni.edu.bd/assets/Admins%2FOffice_New%2FChairperson.jpg"
              alt=""
            />
          </a>
          <div className="p-5">
      ...
      {/* Repeat the Tilt component for the other two images */}
    </div>
  );
};
